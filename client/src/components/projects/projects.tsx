...
type ElectricColor = 'green' | 'yellow' | 'red';
...
const Projects = () => {
  const levels: Level[] = [
    {
        ...
        description: `Master the art of building web interfaces that look stunning on any device. Develop responsive layouts, refine your design sense, and ensure seamless user experiences across desktops, tablets, and mobile platforms with modern CSS techniques.`,
        difficulty: "Easy",
        image: Easy,
    ...
    },
    {
        ...
        description: `Sharpen your problem-solving and coding skills with projects that strengthen logical thinking. Explore patterns, algorithms, and hands-on challenges that boost your analytical mindset, preparing you for tackling more advanced coding tasks with confidence.`,
        difficulty: "Medium",
        image: Medium,
    ...
    },
    {
        ...
        description: `Take your development skills to the next level by focusing on performance, optimization, and advanced concepts. Learn how to build scalable, efficient, and maintainable applications while mastering cutting-edge techniques and best practices.`,
        difficulty: "Hard",
        image: Hard,
        color: "text-red-500",
  ...
  // Electric color mapping with proper typing
  const electricColors: Record<ElectricColor, ColorSet> = {
    green: {
  ...
  return (
    <section className="w-full flex flex-col items-center justify-center gap-5 md:gap-10 px-4">
      {/* SVG Filter Definition - Hidden but functional */}
              ...
              >
                ...
                <div className="relative rounded-xl bg-gradient-to-br from-gray-900/90 to-gray-950/90 backdrop-blur-md overflow-hidden">
                  ...
                  <div className="relative z-10 w-full h-full p-6 flex flex-col min-h-[300px]">
                    ...
                    <div className={`absolute w-full md:w-[100px] flex items-center justify-center text-center top-4 left-auto md:left-63 px-4 py-1 border-2 ${level.borderColor} ${level.color} rounded-full font-semibold text-sm backdrop-blur-md relative overflow-hidden group/badge`}>
                      
                      <div className={`absolute inset-0 rounded-full opacity-0 group-hover/badge:opacity-100 transition-opacity duration-300 ${level.borderColor.replace('border', 'bg')} blur-sm`} />
                    ...
                    <div className='flex flex-col flex-1 justify-center mt-2'>
                      ...
                      <motion.h2 className='-mt-5 text-xl md:text-2xl font-semibold mb-2 text-white'>
                        {level.title}
                      </motion.h2>
